    ...
    <div className='container-fluid foot'>
      ...
      <div className='row mt-3'>
        ...
        <p className='mb-0'>Sanburg branches</p>
          ...
          <div className='row mt-0 text-capitalize'>
        <div className='col-12 col-lg-12'>
          <a href="#" className='text-secondary'>Chennai</a>
        </div>
        </div>
        <div className='row mt-0 text-capitalize'>
        <div className='col-12 col-lg-12'>
          <a href="#" className='text-secondary'>bangalore</a>
        </div>
        </div>
        </div>
        <div className='col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3'>
        ...
        <p className='mb-0'>For Restaurents</p>
          ...
          <div className='row mt-0 text-capitalize'>
        <div className='col-12 col-lg-12'>
          <a href="#" className='text-secondary'>partner with us</a>
        </div>
        </div>
        <div className='row mt-0 text-capitalize'>
        <div className='col-12 col-lg-12'>
          <a href="#" className='text-secondary'>apps for you</a>
        </div>
        </div>
        </div>
        <div className='col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3'>
