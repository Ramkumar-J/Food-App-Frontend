        ...
        <div className="container register-page">
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="col-lg-12">
                    ...
                    <input className="form-control" id="username" type={"text"} name="username" onChange={formik.handleChange} value={formik.values.username}></input>
                    {
                ...
                <div className="col-lg-12">
                    <input className="form-control btn btn-primary rounded-pill"  type={"submit"} value="Signup"></input>
                    </div>
                    </div>
                    </form>
                    </div>
