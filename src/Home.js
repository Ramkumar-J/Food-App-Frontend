...
function Home(props){
  ...
  <div class="carousel-inner border border-5 border-danger">
  ...
  <div className='row mt-2'>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="https://healthyrecipesblogs.com/wp-content/uploads/2013/02/tandoori-chicken-featured-2021.jpg"></img>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="assets/Burger-category.avif"></img>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="assets/Pizza-category.avif"></img>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="https://media.diageocms.com/fit-in/688x688/filters:quality(85)/filters:format(jpg)/media/g2pn1yud/barcom_serve_image_942628_woowoo.jpg"></img>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="https://purobakery.com/wp-content/uploads/2022/03/red-velvet-cake-1-600x600.jpg"></img>
    ...
    <img className='img-fluid rounded-circle h-50 w-100' src="https://content3.jdmagicbox.com/comp/hyderabad/d9/040pxx40.xx40.140619105314.i7d9/catalogue/arun-ice-cream-dealers-habsiguda-hyderabad-ice-cream-parlours-32xcq.jpg"></img>
